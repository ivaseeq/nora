...
#[cfg(test)]
pub(crate) use npm::write_hosted_packument_generation_documents;
pub(crate) use npm::{
    ...
    resume_hosted_maintenance_operation, validate_hosted_packument_generation,
    validate_hosted_packument_pointer,
};
